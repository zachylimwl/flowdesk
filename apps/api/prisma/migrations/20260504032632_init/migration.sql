...
-- CreateIndex
CREATE INDEX "Task_workspaceId_projectId_deletedAt_idx" ON "Task"("workspaceId", "projectId", "deletedAt");

-- CreateIndex
CREATE INDEX "Task_workspaceId_projectId_status_idx" ON "Task"("workspaceId", "projectId", "status");

-- CreateIndex
CREATE INDEX "Task_workspaceId_projectId_position_idx" ON "Task"("workspaceId", "projectId", "position");

-- CreateIndex
CREATE INDEX "Task_parentId_idx" ON "Task"("parentId");

-- CreateIndex
CREATE INDEX "TaskAssignee_workspaceId_userId_idx" ON "TaskAssignee"("workspaceId", "userId");
...
-- CreateIndex
CREATE INDEX "Comment_workspaceId_taskId_deletedAt_idx" ON "Comment"("workspaceId", "taskId", "deletedAt");
...
-- CreateIndex
CREATE INDEX "Attachment_workspaceId_commentId_idx" ON "Attachment"("workspaceId", "commentId");

-- CreateIndex
CREATE INDEX "Label_workspaceId_deletedAt_idx" ON "Label"("workspaceId", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "Label_workspaceId_name_key" ON "Label"("workspaceId", "name");

-- CreateIndex
CREATE INDEX "TaskLabel_workspaceId_labelId_idx" ON "TaskLabel"("workspaceId", "labelId");
...
-- CreateIndex
CREATE INDEX "ApiToken_workspaceId_deletedAt_idx" ON "ApiToken"("workspaceId", "deletedAt");

-- CreateIndex
CREATE INDEX "Webhook_workspaceId_isActive_deletedAt_idx" ON "Webhook"("workspaceId", "isActive", "deletedAt");
...
-- AddForeignKey
ALTER TABLE "TaskAssignee" ADD CONSTRAINT "TaskAssignee_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
